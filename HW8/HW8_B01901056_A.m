                ...
                if tissue1
                    ...
                    % hit boundary of tissue1 and tissue0
                        ...
                        if rand > Re(n1,n0,acos(abs(cz)))
                            ...
                            r = zeros(1,5);
                            for k = 1:5
                                r(k) = sqrt((x-L(k))^2+y^2);
                                if (r(k) < D && acos(cz) < (FOV/180*pi))
                                    if (rand > Re(n0,nd,acos(cz)) || h == 0)
                                        P(k,i) = P(k,i) + w;
                                    end
                                end   
                            end
