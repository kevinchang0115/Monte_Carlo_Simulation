...
%              distribution for laser beams with a Gaussian distribution.
...
%     distribution for a collimated beam that has a Gaussian distribution
%     with an e^-2 radius of 0.5 mm and total power of 7.85 mW. After
%     running this program, we will get a subplot of six graphs. First five
%     are five runs of the simulation of 10000 photons, and the last one is
%     the graph of average values.
...
%     b_radius: the e^-2 radius of the beam with Gaussian distribution (cm)
